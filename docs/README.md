...
> **MVP Status:** ✅ COMPLETE - Permission Hook Phase (v0.1.0)
...
**See:** [MVP Completion Report](./MVP_COMPLETION.md) for full details on what's delivered and future roadmap.
...
### MVP Scope: Permission Hook Only ✅

This MVP focuses exclusively on **permission dialog notifications**. Features planned for future releases:

**Not in this MVP:**
- Stop hook notifications (task completion alerts)
- Idle notifications (user away detection)
- Multiple notification types/sounds
- Web UI for configuration

See [MVP Completion Report](./MVP_COMPLETION.md) for complete roadmap.
