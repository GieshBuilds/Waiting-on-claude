...
[![Tests Passing](https://img.shields.io/badge/tests-347%20passing-brightgreen)]()
[![Coverage](https://img.shields.io/badge/coverage-92%25-brightgreen)]()
[![Python 3.9+](https://img.shields.io/badge/python-3.9%2B-blue)](https://www.python.org/)
[![MVP Complete](https://img.shields.io/badge/MVP-Complete-success)]()
[![License](https://img.shields.io/badge/license-MIT-green)]()

> **MVP Status:** ✅ Permission Hook Phase - COMPLETE (v0.1.0)
...
**Current MVP Phase:** This release focuses exclusively on **permission dialog notifications**. See [MVP Completion Report](./docs/MVP_COMPLETION.md) for full details on what's included and what's planned for future releases.
...
Waiting uses Claude Code's hook system (PermissionRequest and PostToolUse events) to monitor permission dialogs and user responses. When a dialog appears, a hook script starts a timer. If the user doesn't respond within the grace period, the script plays an audio notification. When the user responds (tool completes), another hook signals the audio to stop immediately.
...
- **Version**: 0.1.0 (MVP - Permission Hook Phase)
- **Tests**: 347 passing tests (100% pass rate)
- **Coverage**: 92% overall (all modules ≥80%)
- **Implementation**: Complete with all MVP features
- **Stability**: Production-ready

### MVP Phase: Permission Hook Notifications ✅

This MVP delivers **permission dialog notifications only**. The following features are planned for future releases:

**Not in this MVP:**
- ❌ Stop hook notifications (long-running task completion alerts)
- ❌ Idle notifications (user away detection)
- ❌ Multiple notification types/sounds
- ❌ Web UI for configuration
- ❌ Advanced scheduling or time-based rules

See [MVP Completion Report](./docs/MVP_COMPLETION.md) for complete details on what's delivered and the future roadmap.
...
3. **User Responds**
   - Claude Code triggers PostToolUse hook event (tool completed = user approved)
